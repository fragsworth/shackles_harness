---
name: shackles-producer-high
description: Producer step of the shackles harness at rung high (claude-fable-5-1, effort low); spawned by the driver with a prompt file as its task.
model: fable
effort: low
