---
name: shackles-producer-medium
description: Producer step of the shackles harness at rung medium (claude-opus-5, effort high); spawned by the driver with a prompt file as its task.
model: opus
effort: high
